...
class CreateTolokaTrainingTaskSet(BaseParallelProcessor):
    def __init__(
        self,
        input_data_file: str,
        input_pool_file: str,
    ...
    def process_dataset_entry(self, data_entry):
        tasks = [
            toloka.client.Task(
                input_values={'original': data_entry["original"], 'translation': data_entry["translation"]},
                known_solutions=[
                    toloka.client.task.BaseTask.KnownSolution(output_values={'result': data_entry["result"]})
                ],
                message_on_unknown_solution=data_entry["hint"],
