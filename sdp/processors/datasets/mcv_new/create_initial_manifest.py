...
class CreateInitialManifestMCVNew(BaseParallelProcessor):
    ...
    def prepare(self):
        ...
        print("------------------------------------------", self.transcription_file)
        transcription_file_path = Path(self.transcription_file)
        transcription_file_without_last_component = transcription_file_path.parent
        self.transcription_file = transcription_file_without_last_component
        print("------------------------------------------", self.transcription_file)
