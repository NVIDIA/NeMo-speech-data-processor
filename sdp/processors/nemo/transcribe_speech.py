...
# This file is copied over from https://github.com/NVIDIA/NeMo/blob/r2.4.0/examples/asr/transcribe_speech.py.
# It is currently only compatible with NeMo r2.4.0. To use a different version of NeMo, please modify the file.
