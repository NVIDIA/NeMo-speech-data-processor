...
:meth:`sdp.processors.base_processor.BaseParallelProcessor.test` are specified inside an list under the ``test_cases`` that were provided in the object constructor.
